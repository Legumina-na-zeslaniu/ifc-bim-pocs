...
const bootstrap = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const spatial = new WebIFC.IFC4.IfcRelContainedInSpatialStructure(new WebIFC.IFC4.IfcGloballyUniqueId(crypto.randomUUID()), new WebIFC.Handle(20), null, null, elements, new WebIFC.Handle(102));
...
const spawn = (api, modelId, coords, rotate, size, rgb, name, props) => {
    const origin = [
    ...
    const project = new WebIFC.IFC4.IfcProject(new WebIFC.IFC4.IfcGloballyUniqueId(crypto.randomUUID()), new WebIFC.Handle(20), new WebIFC.IFC4.IfcLabel('project'), new WebIFC.IFC4.IfcText('project description'), null, null, null, [geometry], new WebIFC.Handle(84));
    ...
    const profile = new WebIFC.IFC4.IfcRectangleProfileDef(WebIFC.IFC4.IfcProfileTypeEnum.AREA, new WebIFC.IFC4.IfcLabel('profile'), new WebIFC.Handle(position.expressID), new WebIFC.IFC4.IfcPositiveLengthMeasure(size[0]), new WebIFC.IFC4.IfcPositiveLengthMeasure(size[1]));
    const solid = new WebIFC.IFC4.IfcExtrudedAreaSolid(profile, axis, direction, new WebIFC.IFC4.IfcPositiveLengthMeasure(size[2]));
    ...
    const column = new WebIFC.IFC4.IfcColumn(new WebIFC.IFC4.IfcGloballyUniqueId(crypto.randomUUID()), new WebIFC.Handle(20), new WebIFC.IFC4.IfcLabel(name), null, null, new WebIFC.IFC4.IfcLocalPlacement(null, new WebIFC.IFC4.IfcAxis2Placement3D(new WebIFC.IFC4.IfcCartesianPoint([
        new WebIFC.IFC4.IfcLengthMeasure(coords[0] * 1000),
        new WebIFC.IFC4.IfcLengthMeasure(coords[1] * 1000),
    ...
    ]), null)), product, new WebIFC.IFC4.IfcIdentifier(name), WebIFC.IFC4.IfcColumnTypeEnum.NOTDEFINED);
    api.WriteLine(modelId, column);
    const propertySet = new WebIFC.IFC4.IfcPropertySet(new WebIFC.IFC4.IfcGloballyUniqueId(crypto.randomUUID()), new WebIFC.Handle(20), new WebIFC.IFC4.IfcLabel('Pset_AssetEase'), null, props.map(prop => new WebIFC.IFC4.IfcPropertySingleValue(new WebIFC.IFC4.IfcIdentifier(prop.field), null, new WebIFC.IFC4.IfcLabel(prop.value), null)));
    api.WriteLine(modelId, propertySet);
    const defines = new WebIFC.IFC4.IfcRelDefinesByProperties(new WebIFC.IFC4.IfcGloballyUniqueId(crypto.randomUUID()), new WebIFC.Handle(20), null, null, [column], propertySet);
    api.WriteLine(modelId, defines);
    const color = new WebIFC.IFC4.IfcColourRgb(null, new WebIFC.IFC4.IfcNormalisedRatioMeasure(rgb[0]), new WebIFC.IFC4.IfcNormalisedRatioMeasure(rgb[1]), new WebIFC.IFC4.IfcNormalisedRatioMeasure(rgb[2]));
